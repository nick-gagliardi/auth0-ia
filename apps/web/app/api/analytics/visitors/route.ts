/**
 * API Route: /api/analytics/visitors
 *
 * Fetches unique visitor analytics from Mintlify Analytics API
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const visitorsData = await client.getUniqueVisitors({
      dateFrom,
      dateTo,
    });
    ...
    console.error('Error fetching Mintlify unique visitors:', error);
